...
| 8 | Linux Commands | ls, cd, chmod, grep | Daily sysadmin tasks |
| 9 | Linux Log Analysis | /var/log/auth.log | Security monitoring |
| 10 | Active Directory Lab | VirtualBox + Windows Server | Enterprise simulation |
| 11 | User Management in AD | AD Users & Computers | Identity management |
| 12 | Group Policy (GPO) | GPMC Tool | Security enforcement |
| 13 | Authentication Testing | Active Directory Lab | Real enterprise workflow |
...
By completing these practicals, you will learn how to:

- Monitor CPU, memory, disk, and process activity
- Troubleshoot Windows performance issues
- Analyze Windows event logs
- Detect suspicious processes
- Work with Linux systems and logs
...
- [ ] Practical 13 — Authentication Testing
